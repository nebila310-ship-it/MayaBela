...
import 'package:mayabela/screens/student_programs_screen.dart';
...
List<DashboardEntry> _teacherEntries() {
  ...
  return [
    ...
    DashboardEntry(
      ...
      isVisible: () => access.canAccessTeacherDashboardTile('qa_surveys'),
      builder: (context) => DashboardCard(
        icon: Icons.poll_outlined,
        title: _t('qa_surveys', role),
        color: const Color(0xFF00897B),
        onTap: () => _openTile('qa_surveys', () {
          Navigator.push(
            context,
...
List<DashboardEntry> _staffModuleEntries() {
  ...
  return [
    ...
    entry(
      id: 'staff_student_programs',
      titleId: 'student_programs',
      icon: Icons.emoji_events_outlined,
      color: const Color(0xFFF9A825),
      moduleId: 'student_programs',
      screenBuilder: () => MobileErpHost(
        title: _t('student_programs', adminRole),
        child: const WebStudentProgramsPage(),
      ),
    ),
    entry(
      id: 'staff_qa',
...
List<DashboardEntry> _parentEntries() {
  ...
  return [
    ...
    DashboardEntry(
      ...
      builder: (context) => DashboardCard(
        icon: Icons.emoji_events_outlined,
        title: _t('student_programs', role),
        color: const Color(0xFFF9A825),
        onTap: () => _openTile('student_programs', () {
          Navigator.push(
            context,
            MaterialPageRoute(
  ...
  return switch (roleKey) {
    ...
    AuthService.roleTeacher => [
        ...
        const DashboardSectionDefinition(
          ...
          icon: Icons.menu_book,
          entryIds: ['homework', 'exams', 'lesson_plans', 'curriculum', 'qa_surveys', 'grades', 'timetable', 'learning_materials', 'gallery', 'qr'],
        ),
        const DashboardSectionDefinition(
          title: 'Communication',
          icon: Icons.forum,
