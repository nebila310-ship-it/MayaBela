-- LIA TOR gaps K–Q: student_documents, medication_stock, sel_observations,
-- leadership_tasks. Copies digital-ops readable rules and adds those
-- collections to staff/parent/student IN lists. Apply on Supabase after merge.
