-- LIA Phase J: go-live MFA, privacy consents, data-rights requests,
-- and school backup meta. Copies Phase I readable rules, then adds
-- those collections. MFA secrets are own-username (or admin). Parents
-- and students see only their own consents and requests.
