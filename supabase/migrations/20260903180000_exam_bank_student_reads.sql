-- LIA Phase C: students may read the exam bank / papers for their school
-- and their own attempts. Staff already have school-wide (admin) or
-- unknown-collection (teacher) read. Writes for attempts go through
-- school-upsert-registry.
