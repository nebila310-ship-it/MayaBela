-- LIA Phase I: QA monitoring (observations, curriculum audits, surveys,
-- action research). Copies Phase H readable rules, then adds QA desk
-- reads. Parents/students only see published surveys and their own
-- responses. Observations/audits/research stay staff-side.
