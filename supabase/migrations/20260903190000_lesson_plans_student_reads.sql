-- LIA Phase D: students may read lesson plans for their class (same
-- class-scope path as homework). Staff already have school-wide (admin)
-- or unknown-collection (teacher) read. Writes stay on staff writeBatch.
