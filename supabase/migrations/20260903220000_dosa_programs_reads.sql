...
-- internships, leadership meetings). Copies Phase G readable rules, then
-- adds own-child / own-author reads for program collections. Leadership
-- minutes stay staff-only except published graduation events.
