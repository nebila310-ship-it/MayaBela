...
App id: `com.mayabela.app` · version from `pubspec.yaml` (currently **1.0.6+7**).
...
Verified locally: `flutter build apk --release --target-platform android-arm64` → `com.mayabela.app` **1.0.6+7**.
