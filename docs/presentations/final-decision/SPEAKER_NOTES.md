...
**Words you talk (PDF):** https://gofile.io/d/ltwMaJAg — print or open on your phone  
**Words you talk (markdown):** [TALK_SCRIPT.md](TALK_SCRIPT.md)  
...
The **cover** is split: title on the left, office ERP on the right. Then show **dash-four.png** so the room sees teacher, parent, student, and driver homes — not only the office menu.
...
| 17–18 | Classroom management | Homeroom assignment is a roster. |
| 18–19 | Homework | Teacher posts. Parent and student dashboards show it. |
...
## Live demo order (5–7 minutes)

1. Login screen (School ID).
2. Owner ERP dashboard — office sidebar.
...
- Directors / QA: we will approve grades before parents see them, and we will run findings in this system.
